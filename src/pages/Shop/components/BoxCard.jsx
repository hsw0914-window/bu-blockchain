...
export function BoxCard({ box, onPurchase }) {
  return (
    <Card className="p-6 glass neon-border-cyan hover:neon-border-pink transition-all relative overflow-hidden group">
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-[#a393d1] mb-3 min-h-[40px]">{box.description}</p>
